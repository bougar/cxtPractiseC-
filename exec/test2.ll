...
define i32 @main() #0 {
  %main_nofree = alloca i32*, align 8
  %main_nomalloc = alloca i32*, align 8
  %main_1 = alloca i32*, align 8
  %1 = call noalias i8* @malloc(i64 4) #2
  %2 = bitcast i8* %1 to i32*
  store i32* %2, i32** %main_nofree, align 8
  %3 = call noalias i8* @malloc(i64 4) #2
  %4 = bitcast i8* %3 to i32*
  store i32* %4, i32** %main_1, align 8
  %5 = load i32*, i32** %main_nomalloc, align 8
  %6 = bitcast i32* %5 to i8*
  call void @free(i8* %6) #2
  %7 = load i32*, i32** %main_1, align 8

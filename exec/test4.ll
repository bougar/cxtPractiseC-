...
; Function Attrs: nounwind uwtable
define void @inter(i32* %inter_arg_1) #0 {
  %1 = alloca i32*, align 8
  store i32* %inter_arg_1, i32** %1, align 8
  %2 = load i32*, i32** %1, align 8
  call void @res1(i32* %2)
  ret void
}

; Function Attrs: nounwind uwtable
define void @inter2(i32* %inter2_arg_1) #0 {
  %1 = alloca i32*, align 8
  store i32* %inter2_arg_1, i32** %1, align 8
  %2 = load i32*, i32** %1, align 8
...
define i32 @main() #0 {
  ...
  call void @inter(i32* %1)
  %2 = load i32*, i32** %main_1, align 8
  call void @inter2(i32* %2)
  ret i32 0
}
